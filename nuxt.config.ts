...
export default defineNuxtConfig({
  routeRules: {
    ...
    '/ko': { delayHydration: false },
    '/ja': { delayHydration: false },
    '/todo': { delayHydration: false },
    '/ko/todo': { delayHydration: false },
    '/ja/todo': { delayHydration: false },
    '/calender': { delayHydration: false },
    '/ko/calender': { delayHydration: false },
    '/ja/calender': { delayHydration: false },
    '/setting': { delayHydration: false },
    '/ko/setting': { delayHydration: false },
    '/ja/setting': { delayHydration: false },
  },
  devServer: {
    port: 3000,
  },
